...
CREATE TABLE "GuildStats" (
    ...
    CONSTRAINT "GuildStats_pkey" PRIMARY KEY ("id","period","module")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "GuildStats_id_key" ON "GuildStats"("id");
...
-- AddForeignKey
ALTER TABLE "GuildStats" ADD CONSTRAINT "GuildStats_id_fkey" FOREIGN KEY ("id") REFERENCES "Guild"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
