      ...
      <Card className="w-full max-w-md">
        <CardBody className="items-center gap-4 py-8 text-center">
          ...
          <div className="space-y-1">
            ...
            {/* ponytail: no error message shown to the user — it can leak
                infra details (DB URLs, API tokens). The digest below is the
                one thing that's safe to show and lets us match this to
                server-side logs. */}
