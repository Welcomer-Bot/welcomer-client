...
import { ModulePageView } from "@/features/dashboard/modules/views/module-page-view";
...
export default async function Page({
  ...
  return <ModulePageView guildId={guildId} moduleSlug={module as DashboardModuleSlug} />;
}
